...
if (isset($_POST['submit'])) 
{
	...
	$sql = "UPDATE user SET fname='$fname', mname='$mname', lname='$lname', age='$age',gender='$gender', address='$address', email='$email', contactno='$contactno',username='$username',password='$password' WHERE id='$id'";
	mysqli_query($database, $sql);

	echo "<script>alert('Profile Updated'); window.location.href='customereditprofile.php'</script>";
}
