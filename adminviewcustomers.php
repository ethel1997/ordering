...
$result = mysqli_query($database, "SELECT * FROM `user` WHERE type = 'customer' ORDER BY id DESC");
	...
	<div class="container">
		...
		<table border="1" width="80%">
			...
			while ($res = mysqli_fetch_array($result))
			{
				...
				echo "<td><a href=\"admindeletecustomer.php?id=$res[id]\"onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
			}
