...
if (isset($_POST['submit'])) 
{
	...
	$display = "INSERT INTO user(fname, mname, lname, age, address, email, contactno, gender,username, password,type) values('$fname', '$mname', '$lname', '$age', '$address', '$email', '$contactno', '$gender','$username', '$password', '$type')";
